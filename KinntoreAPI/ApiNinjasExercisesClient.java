...
public class ApiNinjasExercisesClient {
     ...
     */
    public void run() {
        // ターミナルからShift_JISで筋肉名を入力し、UTF-8に変換してAPIリクエスト
        ...
        System.out.print("\n\n上記の中から検索したい筋肉名を入力してください (日本語で/Shift_JIS): ");
        Optional<String> sjisInputOpt = EncodingConverter.readLineFromTerminal("MS932");
        String muscleToSearchJa = sjisInputOpt.orElse("").trim();
